  ...
  return (
    <ReactMarkdown
      components={{
        ...
        h1: ({ children }) => (
          <h1 className="title-base md:title-large mb-4">
        ...
        h2: ({ children }) => (
          <h2 className="title-small md:title-medium mb-4">
            <div className="flex w-auto items-center text-start">
              {children}
            </div>
          </h2>
        ...
        h3: ({ children }) => (
          <h3 className="title-small-sb-16px md:title-base mb-4 text-start">
            {children}
          </h3>
        ),
        h4: ({ children }) => (
          <h4 className="title-small-med-16px md:title-small mb-4 text-start">
            {children}
          </h4>
        ),
        ...
        ol: ({ children }) => (
          <ol className="flex list-decimal flex-col pl-10 body-base md:text-justify">
            {children}
          </ol>
        ),
        p: ({ children }) => (
        ...
        ul: ({ children }) => (
          <ul className="flex list-disc flex-col pl-10 body-base md:text-justify">
            {children}
          </ul>
        ),
      }}
