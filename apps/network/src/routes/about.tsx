...
import headerImage from '#src/assets/about/header.webp';
import headerSmallImage from '#src/assets/about/header-small.webp';
import media1Image from '#src/assets/about/media-1.webp';
import media1SmallImage from '#src/assets/about/media-1-mobile.webp';
