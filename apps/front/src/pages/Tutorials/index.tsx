    ...
    <MainLayout footerVariant="light">
      <div className=" flex flex-col justify-center bg-gray-100">
        <div className="bg-primary-900 relative mb-10 flex flex-col items-center px-5 pb-10 pt-8 text-white md:mb-60 md:pb-80 lg:px-16 lg:pb-60">
          <div className="flex w-full flex-wrap items-center justify-evenly lg:space-x-5">
            <div className="px-5 lg:px-0">
              <h1 className="-ml-6 mb-5 text-[62px] font-thin md:text-7xl lg:text-8xl xl:text-[128px]">
            ...
            <img
              className="mb-10 mt-6 max-h-72 md:max-h-60 lg:max-h-80 xl:max-h-96"
              src={tutoRabbitPng}
              alt=""
            />
          </div>
