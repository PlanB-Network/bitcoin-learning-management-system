...
export const Home = () => {
  ...
  return (
    <MainLayout footerVariant="dark">
      <div className="bg-primary-900 flex w-full justify-center px-5 md:px-10 lg:px-32 xl:px-0">
      ...
      {/* 1rst Section */}
      <div className="bg-primary-800 flex w-full justify-center px-5 md:px-10 lg:px-32 xl:px-0">
      ...
      <div className="bg-primary-800 flex w-full justify-center px-5 md:px-10 lg:px-32 xl:px-0">
        <div className="w-full max-w-6xl py-10">
          ...
          <p className="text-secondary-400 my-8 w-full text-center italic">
            {t('home.third.more')}
          </p>
        </div>
      </div>
      ...
      {/* About us */}
      <div className="bg-primary-700 flex w-full justify-center px-5 md:px-10 lg:px-32 xl:px-0">
