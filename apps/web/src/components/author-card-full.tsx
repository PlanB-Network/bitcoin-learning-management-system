...
export const AuthorCardFull = ({
  ...
  return (
    <div {...props}>
      <article className="flex flex-col p-3.5 md:p-0 gap-5 mt-8">
        <div className="flex max-md:flex-col max-md:gap-4 md:items-top gap-7">
          <div className="rounded-[20px] bg-white p-2 mx-auto lg:mx-0 w-[280px]">
            ...
            <div className="flex items-center justify-center">
              <button
                className="flex items-center overflow-hidden hover:bg-darkOrange-0 shrink-0"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  openTipModal();
              ...
              >
                <DonateLightning className="size-10" />
          ...
          <div className="flex flex-col items-start align-top">
            <div className="flex flex-wrap content-center items-center gap-2 self-stretch text-sm text-white sm:gap-5 sm:text-2xl max-w-[596px]">
