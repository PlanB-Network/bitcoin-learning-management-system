...
export const TutorialExplorer = () => {
  ...
  return (
    <div className=" flex flex-col justify-center bg-gray-100">
      <div className="bg-blue-900 relative mb-10 flex flex-col items-center px-5 pb-10 pt-8 text-white md:mb-80 md:pb-80 lg:mb-60 lg:px-16 lg:pb-60">
        ...
        <div className="bg-blue-700 inset-x-0 bottom-0 left-1/2 z-10 flex w-full max-w-min flex-row flex-wrap justify-evenly rounded-3xl px-12 py-8 shadow md:absolute md:max-w-3xl md:-translate-x-1/2 md:translate-y-1/2 lg:max-w-5xl">
          {TUTORIALS_CATEGORIES.map((tutorialCategory) => (
            ...
            >
              <div
                className="hover:bg-blue-600 relative my-4 box-content flex h-24 w-64 cursor-pointer flex-row rounded-lg p-2 duration-300"
                key={tutorialCategory.name}
              >
                <div className="bg-orange-400 absolute z-0 flex h-24 w-24 rounded-full">
                  <img
