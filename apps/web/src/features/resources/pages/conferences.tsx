...
import { ConferencesTimeLine } from '../components/Timelines/mobile-conferences.tsx';
...
export const Conferences = () => {
  ...
  return (
    <ResourceLayout
      ...
      className="mx-0 px-0"
    >
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 text-white gap-3 md:gap-7 mx-4">
        <div className="flex flex-col gap-1 md:gap-4 md:col-span-1 lg:col-span-2">
          ...
          <div className="grid max-md:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-2.5 md:gap-8">
            ...
            <div className="w-full h-60 bg-red-500 md:hidden lg:block"></div>
          </div>
        </div>
