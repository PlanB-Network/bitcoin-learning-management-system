...
export const Route = createFileRoute('/_misc/terms-and-conditions')({
  component: TermsAndConditions,
});

function TermsAndConditions() {
  const { t } = useTranslation();
  const termsString = `# MENTIONS LÉGALES

  Identification de l'éditeur et de l'hébergeur du site
  
  Le site https://planb.network est édité par DecouvreBitcoin SAS, au capital de 5000 €, entreprise immatriculée au 904 364 445 RCS de lille metropole sous le numéro , dont le siège social est sis au 6 rue louis neel, 59260 lezennes.
  N° de TVA intracommunautaire : FR49 904 364 445.
  Directeur de la publication : clement , Clément de DecouvreBitcoin SAS, joignable au ou à l'adresse clement@decouvrebitcoin.com.
  ...
  Tous droits réservés - 16 fevrier 2024
  ...
  Le présent Site est édité par DecouvreBitcoin SAS. Les informations légales concernant l'hébergeur et l'Editeur du Site, notamment les coordonnées et les éventuelles informations de capital et d'immatriculation, sont fournies dans les mentions légales du présent Site.
  ...
  L'objet du présent Site est déterminé comme « PlanB Network ».
  ...
  Chaque Utilisateur est libre de fermer son compte et ses données sur le Site. Pour ceci, il doit adresser un e-mail à PlanB Network indiquant qu'il souhaite supprimer son compte. Aucune récupération de ses données ne sera alors possible.
  ...
  Le Site fournit à l'Utilisateur des informations à titre indicatif, avec des imperfections, erreurs, omissions, inexactitudes et autres ambivalences susceptibles d'exister. En tout état de cause, DecouvreBitcoin ne pourra en aucun cas être tenu responsable :
  ...
  ## Article 9 - Contribution des Utilisateurs au contenu du Site
  ...
  Tous droits réservés - 15 fevrier 2024
  
  
  # CONDITIONS GÉNÉRALES DE VENTE 
  
  Définitions
  Les présentes Conditions Générales de Vente (ci-après les « CGV ») sont proposées par DecouvreBitcoin SAS, au capital de 5000 €, entreprise immatriculée au 904 364 445 RCS de lille metropole sous le numéro , dont le siège social est sis au 6 rue louis neel, 59260 lezennes (ci-après « DecouvreBitcoin »).
  On désignera par la suite :
  •	« Site » : le site https://planb.network et l'ensemble de ses pages.
  ...
  •	« Vendeur » : DecouvreBitcoin, personne morale ou physique, proposant ses Produits ou Services sur le Site.
  ...
  Le présent Site propose la vente en ligne de Produit asscocié a l'utilisation et l'étude de Bitcoin tel que des livres, formation, séminaire en ligne, objets impression 3D, posters, vêtements, clé de sécurités, matériel électroniques, stickers, blasons, certificats, caisses, sacs ect .
  ...
  Les photographies ou curriculum des Produits du catalogue reflètent une image fidèle des Produits et Services proposés mais ne sont pas constitutives d'un engagement contractuel dans la mesure où elles ne peuvent pas assurer une parfaite similitude avec les Produits physiques.
  ...
  DecouvreBitcoin se réserve le droit à tout moment de modifier ses prix et de répercuter, si applicable, tout changement du taux de TVA en vigueur sur le prix des Produits ou Services proposés sur le Site. Néanmoins, le prix figurant au catalogue le jour de la commande sera le seul applicable au Client.
  Le Client peut passer commande sur le présent Site et peut effectuer son règlement par Bitcoin, carte bancaire. Les paiements par carte bancaire se font au moyen de transactions sécurisées fournies par un prestataire de plateforme de paiement en ligne.
  ...
  DecouvreBitcoin archivera les bons de commandes et les factures sur un support fiable et durable constituant une copie fidèle. Les registres informatisés seront considérés par les parties comme preuve des communications, commandes, paiements et transactions intervenus entre les parties.
  
  ## Article 5 - Livraisons
  
  Les frais de livraison seront indiqués au Client avant tout règlement et ne concernent que les livraisons effectuées en Zone european . Pour tout autre lieu de livraison, il appartiendra au Client de prendre contact avec le service clientèle.
  ...
  Le remboursement sera effectué en utilisant le même moyen de paiement que celui choisi par le Client pour la transaction initiale, sauf accord exprès du Client pour que le Vendeur utilise un autre mode de paiement, et dans la mesure où le remboursement n'occasionne pas de frais pour le Client. Dans le cas où la transaction initiale a été effectuée dans une devise autre que l'EURO ou implique une monnaie virtuelle telle que le Bitcoin, le remboursement sera effectué au montant initial équivalent en EURO, calculé selon le taux de change officiel en vigueur à la date de la transaction initiale. Ceci garantit que le Client est remboursé du montant exact en EURO dépensé lors de l'achat, indépendamment de toute fluctuation de la devise ou de la monnaie virtuelle entre la date de la transaction et la date du remboursement.
  ...
  A l'attention de DecouvreBitcoin SAS, 6 rue louis neel, 59260, lezennes
  ...
  Le service clientèle du présent Site est accessible par courrier électronique à l'adresse suivante rogzy@decouvrebitcoin.com ou par courrier postal à l'adresse indiquée dans les mentions légales.
  
  ## Article 9 - Responsabilité
  
  Le Vendeur DecouvreBitcoin ne saurait être tenu pour responsable de l'inexécution du contrat conclu due à la survenance d'un événement de force majeure. Concernant les Produits achetés, le Vendeur n'encourra aucune responsabilité pour tous dommages indirects du fait des présentes, perte d'exploitation, perte de profit, dommages ou frais, qui pourraient survenir.
  ...
  Le Client admet expressément utiliser le Site à ses propres risques et sous sa responsabilité exclusive. Le Site fournit au Client des informations à titre indicatif, avec des imperfections, erreurs, omissions, inexactitudes et autres ambivalences susceptibles d'exister. En tout état de cause, DecouvreBitcoin ne pourra en aucun cas être tenu responsable :
  •	de tout dommage direct ou indirect, notamment en ce qui concerne les pertes de profits, le manque à gagner, les pertes de clientèle, de données pouvant entre autres résulter de l'utilisation du Site, ou au contraire de l'impossibilité de son utilisation ;
  ...
  ## Article 11 - Indépendances des clauses
  ...
  A ce titre DecouvreBitcoin propose à ses Clients Consommateurs, dans le cadre de litiges qui n'auraient pas trouvé résolution de manière amiable, la médiation d'un médiateur de la consommation, dont les coordonnées sont les suivantes :
  ...
  Bienvenue sur PanB Network, votre plateforme d'e-learning dédiée à l'apprentissage en ligne. La protection de votre vie privée est au cœur de nos préoccupations, et cette politique de confidentialité vise à vous informer sur la manière dont nous recueillons, utilisons et protégeons vos données personnelles.
  
  1. Collecte de Données
  PanB Network s'engage à minimiser la collecte de données. Nous ne recueillons que les informations essentielles à la création et à la gestion de votre compte, notamment :
  •	Nom d'utilisateur
  •	Adresse e-mail
  Nous n'utilisons pas de trackers supplémentaires et ne collectons aucune donnée personnelle au-delà de celles strictement nécessaires à l'exploitation de votre compte.
  2. Utilisation des Cookies
  Notre site utilise des cookies pour améliorer votre expérience utilisateur. Ces cookies sont de petits fichiers stockés sur votre appareil qui nous aident à :
  •	Assurer le bon fonctionnement de la plateforme
  •	Comprendre comment vous interagissez avec notre site
  Vous avez la possibilité de gérer vos préférences de cookies à travers les paramètres de votre navigateur.
  3. Partage et Divulgation
  PanB Network ne partage, ne vend, ni ne divulgue vos données personnelles à des tiers, sauf si requis par la loi.
  4. Sécurité des Données
  Nous prenons des mesures de sécurité appropriées pour protéger contre l'accès non autorisé, la modification, la divulgation ou la destruction de vos données personnelles.
  5. Vos Droits
  Vous disposez de droits concernant vos données personnelles, y compris le droit d'accès, de rectification, et de suppression de vos données. Pour exercer ces droits, veuillez nous contacter à clement@decouvrebitcoin.com.
  6. Modifications de la Politique de Confidentialité
  Nous nous réservons le droit de modifier cette politique de confidentialité à tout moment. Les changements entreront en vigueur immédiatement après leur publication sur notre site.
  
  Pour toute question ou préoccupation concernant cette politique, n'hésitez pas à nous contacter à clement@decouvrebitcoin.com ou au 6 rue louis neel 59260 lezennes, France DecouvreBitcoin SAS. 
  `;
