...
export const EventsPassed = ({
  ...
  return (
    <>
      <section className="max-w-[1440px] w-full flex flex-col px-4 mt-6 mx-auto md:mt-15 md:px-10">
        <div className="h-px w-2/5 bg-newBlack-5 mb-6 md:mb-15 mx-auto sm:w-full" />
        <div className="max-w-[704px] mx-auto">
          ...
          <p className="text-sm text-center text-newGray-1 mb-6 tracking-015px md:text-base md:mb-15">
            {t('events.missed.missedP2')}
          </p>
        </div>
        <h2 className="text-lg text-center font-medium mb-4 sm:text-xl sm:text-left md:mb-15">
