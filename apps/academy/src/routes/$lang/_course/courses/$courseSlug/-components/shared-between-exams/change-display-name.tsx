    ...
    <div className="flex flex-col w-full max-w-[604px] max-md:gap-4">
      ...
      <section className="flex flex-col md:mt-5 gap-2">
        ...
        <div className="flex max-lg:flex-col lg:items-center gap-4 md:gap-5">
          ...
          <span
            id="displayName"
            className="rounded-md bg-commentTextBackground border border-neutral-500/10 px-4 py-2 text-neutral-500 text-sm leading-[120%] w-full max-w-[302px] h-8 truncate"
