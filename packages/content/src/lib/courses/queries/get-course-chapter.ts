...
export const getCourseChapterQuery = (
  ...
  return sql<JoinedCourseChapterWithContent[]>`
    SELECT ch.part_id, cl.chapter_id, part_index, chapter_index, language, title, sections, release_place, raw_content, is_online, is_in_person, 
