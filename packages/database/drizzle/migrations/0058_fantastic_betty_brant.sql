...
ALTER TABLE "content"."projects" DROP CONSTRAINT "builders_resource_id_resources_id_fk";--> statement-breakpoint
...
ALTER TABLE "content"."projects" ADD CONSTRAINT "projects_id_unique" UNIQUE("id");--> statement-breakpoint
