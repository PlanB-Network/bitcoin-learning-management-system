...
ALTER TABLE "content"."course_translation_slides" ADD CONSTRAINT "course_translation_slides_to_translation_chapters_fk" FOREIGN KEY ("course_id","language","part_id","chapter_id") REFERENCES "content"."course_translation_chapters"("course_id","language","part_id","chapter_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
