...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "content"."glossary_words_localized" ADD CONSTRAINT "glossary_words_localized_glossary_word_id_builders_resource_id_fk" FOREIGN KEY ("glossary_word_id") REFERENCES "content"."builders"("resource_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
