...
>(({ className, align = 'center', addAnimation = true, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      align={align}
      className={cn(
        'z-40 rounded-md bg-popover text-popover-foreground outline-hidden data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95',
        addAnimation &&
