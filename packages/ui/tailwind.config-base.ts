  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-tabs':
          'linear-gradient(0deg, rgba(255, 92, 0, 0.40) 0%, rgba(0, 0, 0, 0.00) 100%)',
        'home-gradient':
      ...
      boxShadow: {
        ...
        'course-navigation-sm-accent': '0px 2px 2px 0px rgba(0, 0, 0, 0.48)',
        'sm-card-dark': '0px 0px 10px 0px #FF5C00',
        'sm-card-light': '0px 0px 10px 0px #FF975C',
